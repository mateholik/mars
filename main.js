...
const spanWindDirectionCardinal = document.getElementById('windDirectionCardinal');
const spanWindDirectionDegrees = document.getElementById('windDirectionDegrees');
...
function displaySelectedSol(sols) {
  ...
  spanWindDirectionDegrees.innerHTML = selectedSol.windDirectionDegrees;
...
function displayPreviousSols(sols) {
  ...
  sols.forEach((solData, index) => {
    ...
    solContainer.getElementById('previous-date').innerHTML = formatDate(solData.date);
    solContainer.getElementById('previous-maxTemp').innerHTML = formatTemperature(solData.maxTemp);
    solContainer.getElementById('previous-minTemp').innerHTML = formatTemperature(solData.minTemp);
    solContainer.getElementById('previous-sol').innerHTML = solData.sol;
    solContainer.getElementById('previous-button').addEventListener('click', () => {
